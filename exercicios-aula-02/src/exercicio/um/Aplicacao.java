...
//        regresso.reproduzir();
//
        Ator angelinaJolie = new Ator("Angelina Jolie", LocalDate.of(1975,12,1), 2, Genero.FEMININO);
        Ator scarlettJohansson = new Ator("Scarlett Johansson",LocalDate.of(1985,6,15), 1, Genero.FEMININO);
